...
void pTurn(){
  ...
  //delay(50);
 // int val1_2 = readDistance();
 // delay(50);
  //int val1_3 = readDistance();
  //int val1=(val1_1+val1_2+val1_3)/3;
  enableDisableSensor(5); // Turn on sensor attached to pin 2 and disable all others
  int val2 = readDistance();
  //delay(50);
  //int val2_2 = readDistance();
  //delay(50);
  //int val2_3 = readDistance();
  //int val2=(val2_1+val2_2+val2_3)/3;
  delay(100);
  ...
  if (val1>400 &&val1<700&&val2>400&&val2<700){
...
//   
   ...
   //new
   if(val2>900 || val1>900){
    return;
   }

   //new
   //values should be 860
   if(val1>700 || val2>700){
    counter++;
   }else{
    counter==0;
   }
